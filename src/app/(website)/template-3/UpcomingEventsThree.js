...
export default function UpcomingEventsThree({ upcomingEvents }) {
  ...
  return (
    <div className="bg-[#eef3f7] py-5">
      <div className="container mx-auto px-4 md:px-6 py-8 sm:py-10">
        <div className="flex flex-col lg:flex-row items-center justify-between relative mb-8">
          <div className="text-left">
            <h2 className="text-6xl md:text-8xl font-weight-500 text-gray-800 opacity-15 absolute top-1/4 left-0 w-full transform -translate-y-1/2">
              DESTINATION
            </h2>
            <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 relative uppercase mt-6 z-10 inline-block">
              Our Upcoming Events
            </h2>
            <p className="text-gray-600 mt-2 text-center md:text-left pt-10">
          ...
          <div className="">
            <button
              ...
              className="text-white bg-orange-700 px-4 py-3 font-500 flex items-center hover:underline text-sm sm:text-base"
            >
              View All Events
              <button
                onClick={(e) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative w-full h-[400px] sm:h-[420px]">
                      ...
                      {/* Title */}
                      <div className="absolute bottom-4 left-1/2 py-4 bg-black w-full transform -translate-x-1/2 translate-y-4 group-hover:translate-y-0 transition-all duration-500 ease-in-out text-center">
