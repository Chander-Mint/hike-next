        ...
        <footer className="bg-[#333] text-white  pt-8 pb-3 px-4 sm:px-6">
            <div className="container mx-auto px-6 pt-10 pb-10 flex flex-wrap gap-8 sm:gap-12 justify-between">
                ...
                <div className="w-full sm:w-auto lg:max-w-sm flex flex-col items-center sm:items-start">
                    <Image width={200} height={100} src="/hike_logo.png" alt="Hike" className="w-28 sm:w-32 mb-3 sm:mb-4" />
                    <p className="text-sm sm:text-base font-400 leading-relaxed text-center sm:text-left">
                        Hike is dedicated to promote mountaineering, extreme sports, and responsible tourism.
                        We inspire adventurers through expert-led expeditions while promoting environmental conservation.
                        Our mission is to elevate India mountaineering community on the global stage.
                    </p>
                </div>
                ...
                <div className="w-full lg:w-auto lg:min-w-fit flex flex-col items-start">
                    ...
                    <ul className="space-y-1 mt-2 text-base sm:text-md whitespace-nowrap">
                        <li><a href="/event" className="hover:underline">All Events</a></li>
                        <li><a href="#" className="hover:underline">Rent</a></li>
                        <li><a href="/blog" className="hover:underline">Blogs</a></li>
                        <li><a href="/privacy" className="hover:underline">Privacy Policy</a></li>
                        <li><a href="/career" className="hover:underline">Career in Hike</a></li>
                ...
                <div className="w-full sm:w-auto max-w-xs flex flex-col items-start">
                    ...
                    <ul className="space-y-3 sm:space-y-4 mt-3 sm:mt-4 text-base text-md font-light">
                        <li className="text-md flex items-start gap-2 sm:gap-3">
                            ...
                            <span>Plot No 78, Industrial Area Phase I, Chandigarh 160002</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                            {/* <Icon icon="mdi:phone" className="text-xl sm:text-2xl" /> */}
                            <a href="tel:+918288969648" className="hover:underline">+91 8288969648</a>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                            {/* <Icon icon="mdi:email-outline" className="text-xl sm:text-2xl" /> */}
                            <a href="mailto:info@hike.com" className="hover:underline">info@hike.com</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="mt-10 border-t border-gray-400 pt-3 sm:pt-4 flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center sm:justify-between text-sm sm:text-base max-w-7xl mx-auto">
                <div className="text-center sm:text-left flex items-center">
                    <p>Copyright © 2025, Hike. | All Rights Reserved</p>
                    <p>
                ...
                <div className="flex gap-3 sm:gap-4">
                    <a href="#" target="_blank">
                        <Icon icon="mdi:facebook" className="text-xl sm:text-xl" />
                    </a>
                    <a href="#" target="_blank">
                        <Icon icon="mdi:twitter" className="text-xl sm:text-xl" />
                    </a>
                    <a href="#" target="_blank">
                        <Icon icon="mdi:linkedin" className="text-xl sm:text-xl" />
                    </a>
                    <a href="#" target="_blank">
                        <Icon icon="mdi:instagram" className="text-xl sm:text-xl" />
                    </a>
                    <a href="#" target="_blank">
                        <Icon icon="mdi:youtube" className="text-xl sm:text-xl" />
                    </a>
                </div>
            </div>
